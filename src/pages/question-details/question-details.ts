...
export class QuestionDetailsPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public storage: Storage, public events: Events, public http: HttpClient) {
    ...
    events.subscribe('comment:created', (comment) => {
      ...
      this.http.post('http://sprypixels.com/demo/askinsurpedia/public/api/questions/comment', {
        user: this.user.id,
